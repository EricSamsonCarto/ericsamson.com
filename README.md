...
My personal space for projects, writing, and exploring how data gets visualized on maps.
...
Built with [Astro](https://astro.build) and [Tailwind CSS](https://tailwindcss.com). Hosted on Netlify.
...
- `projects/` – Project writeups and demos
