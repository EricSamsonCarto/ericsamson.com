...
<Image src="/images/projects/kincade-fire/kincade-spread.gif" alt="GIF of Sentinel-2 data showing the expanding fire over the course of 9 days" width={1200} height={800} />
...
<Image src="/images/projects/kincade-fire/kincade-map-analysis.jpg" alt="Maps Created using data from ESRI and the County of Sonoma" width={1200} height={800} />
