...
$.when(CampLand1, NoCampLand1, Background1, PrivateLand1, BLM1).done(function() {
  var map = L.map("map",{
    ...
    minZoom: 6,
    maxZoom: 19
  }).setView([37.732941, -120.915037], 6);

map.on('load', function() {
    map.flyTo([37.52715, -120.43213], 6);
});

$('.agree').on('click', function(){
  map.setView([37.52715, -120.43213], 6);
...
var officialLogo = L.icon({
    iconUrl: 'https://assets.codepen.io/3352342/Official_Campsite.svg',
    iconSize: [28, 29],
});
...
//BIND POPUP FOR OFFICIAL CAMPSITES
OFF_Campsites.bindPopup(function (layer) {
    return L.Util.template('<font size="2px"><b>Campground Name:</b> {RECAREANAME} <br> <b>Campsite Webpage:</b> <a href={RECAREAURL}>Link</a> <br> <b>Activity Type:</b> {MARKERACTIVITY} <br> <b>Open Status:</b> {OPENSTATUS}</font>', layer.feature.properties);
  });
...
var Trailheadlogo = L.icon({
    iconUrl: 'https://assets.codepen.io/3352342/Official_Trailhead.svg',
    iconSize: [28, 29],
});
...
//MARKER DESIGN
var campIcon = L.icon({
    iconUrl: 'https://assets.codepen.io/3352342/Custom_Campsite.svg',
    iconSize: [28, 29],
});
...
var Link = `
     ${res}
     <b>
<hr style="padding: 0; margin: 0; height:1px; border:none; background-color:#FFFFFF; width:100%; text-align:center; margin-bottom: .1rem;">
